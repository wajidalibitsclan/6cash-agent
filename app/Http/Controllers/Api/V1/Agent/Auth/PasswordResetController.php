...
class PasswordResetController extends Controller
{
    ...
    public function reset_password_request(Request $request): JsonResponse
    {
        ...
        if ($validator->fails()) {
            return response()->json(['code' => 'validation-error', 'errors' => Helpers::error_processor($validator)], 403);
        }
        ...
        if (isset($customer)) {
            ...
            try {
                ...
                // $response = $this->twilio->sendOTP($customer['phone'], $messageBody);
    ...
    public function verify_token(Request $request): JsonResponse
    {
        ...
        if (isset($data)) {
            ...
            return response()->json(['code' => 'success', 'message' => "OTP found, you can proceed"], 200);
        } else {
    ...
    public function reset_password_submit(Request $request): JsonResponse
    {
        ...
        if (isset($data)) {
            ...
            if ($request['password'] == $request['confirm_password']) {
                ...
                return response()->json(['code' => 'success', 'message' => 'Password changed successfully.'], 200);
            }
            return response()->json(['errors' => [
