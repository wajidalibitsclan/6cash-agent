...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'checkAuthToken' => \App\Http\Middleware\TokenSessionMIddleware::class,
        'guestAuthAgent' => \App\Http\Middleware\TokenSessionGuestMiddleware::class,
        'preventPage' => \App\Http\Middleware\PreventPagesMiddleware::class,
    ];
}
