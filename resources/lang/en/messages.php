<?php return array (
  ...
  'set your 4 digit Pin for future login' => 'Set your 4 digit Pin for future login',
  'set your PIN' => 'Set your PIN',
  'Your PIN is invalid. Please try again.' => 'Your PIN is invalid. Please try again.',
  'confirm PIN' => 'Confirm PIN',
  'confirm PIN is invalid. Please try again.' => 'Confirm PIN is invalid. Please try again.',
  'Join' => 'Join',
  'join us' => 'Join us',
  ...
  'home' => 'Home',
  'history' => 'History',
  'Complete your account verification' => 'Complete your account verification',
  'PIN updated successfully' => 'PIN updated successfully',
  'Old PIN is incorrect' => 'Old PIN is incorrect',
  '' => '',
  'Register Page' => 'Register Page',
  'OTP Page' => 'OTP Page',
  'Set PIN' => 'Set PIN',
  'Your account is not verified, Complete your account verification' => 'Your account is not verified  Complete your account verification',
  'Your account do not have enough balance' => 'Your account do not have enough balance',
  'wajid' => 'Wajid',
  'Your account is blocked!' => 'Your account is blocked!',
  'You account is not verified yet!' => 'You account is not verified yet!',
  'Verify?' => 'Verify?',
  ...
  'Trasaction History' => 'Trasaction History',
  'Transaction Type' => 'Transaction Type',
  'User Info' => 'User Info',
  'Empty Records!' => 'Empty Records!',
  'Requests' => 'Requests',
  'Withdraw Method Fields' => 'Withdraw Method Fields',
  ...
  'Policies' => 'Policies',
  'Support' => 'Support',
  'What is 6Cash?' => 'What is 6Cash?',
  'faq_page_ans' => 'It is a long established fact that a reader will be distracted by the readable
  ...
  'faq_page_ans_two' => 'It is a long established fact that a reader will be distracted by the readable
  content of a page when looking at its layout. The point of using Lorem Ipsum is
  that it has a more-or-less normal distribution of letters, as opposed to using
  "Conternt here, content here, making it look like readable English. Many desktop
  publishing packages and web page editors now use Lorem lpsum as their default
  model text, and a search for "lorem ipsum" will uncover many web sites still in
  their infancy. Various versions have evolved over the years, sometimes by
  accident, sometimes on purpose (injected humour and the like).',
  'Who can use?' => 'Who can use?',
  'faq_page_ans_three' => 'It is a long established fact that a reader will be distracted by the readable
  content of a page when looking at its layout. The point of using Lorem Ipsum is
  that it has a more-or-less normal distribution of letters, as opposed to using
  "Content here, content here", making it look like readable English. Many desktop
  publishing packages and web page editors now use Lorem lpsum as their default
  ...
  their infancy. Various versions have evolved over the years, sometimes by
  accident, sometimes on purpose (injected humour and the like).',
  'privacy_policy_para' => 'This policy explains how StackFood website and related applications (the "Site", "we" or
  "us") collects, uses, shares and protects the personal information that we collect through
  this site or different channels. StackFood has established the site to link up the users who
  need foods or grocery items to be shipped or delivered by the riders from the affiliated
  restaurants or shops to the desired location. This policy also applies to any mobile
  applications that we develop for use with our services on the Site, and references to this
  "Site", "we" or "us" is intended to also include these mobile applications. Please read
  below to learn more about our information policies. By using this Site, you agree to these
  policies.',
  'privacy_policy_heading' => 'How the Information is collected',
  'privacy_policy_heading_two' => 'Information provided by web browser',
  'privacy_policy_para_two' => 'You have to provide us with personal information like your name, contact no, mailing address
  and email id, our app will also fetch your location information in order to give you the
  best service. Like many other websites, we may record information that your web browser
  routinely shares, such as your browser type, browser language, software and hardware
  attributes, the date and time of your visit, the web page from which you came. your Internet
  Protocol address and the geographic location associated with that address, the pages on this
  Site that you visit and the time you spent on those pages. This will generally be anonymous
  data that we collect on an aggregate basis.',
  'privacy_policy_heading_three' => 'Personal Information that you provide',
  'privacy_policy_para_fourth' => 'If you want to use our service, you must create an account on our Site. To establish your
  account, we will ask for personally identifiable information that can be used to contact or
  identify you, which may include your name, phone number, and e-mail address. We may also
  collect demographic information about you, such as your zip code, and allow you to submit
  additional information that will be part of your profile. Other than basic information that
  we need to establish your account, it will be up to you to decide how much information to
  share as part of your profile. We encourage you to think carefully about the information
  that you share and we recommend that you guard your identity and your sensitive information.
  Of course, you can review and revise your profile at any time.
  Payment Information To make the payment online for availing our services, you have to
  provide the bank account, mobile financial service (MES), debit card, credit card
  information to the StackFood platform.',
  'privacy_policy_heading_fourth' => 'How the Information is collected',
  'privacy_policy_heading_fifth' => 'Session and Persistent Cookies',
  'privacy_policy_para_fifth' => 'Cookies are small text files that are placed on your computer by websites that you visit.
  They are widely used in order to make websites work, or work more efficiently, as well as to
  provide information to the owners of the site. As is commonly done on websites, we may use
  cookies and similar technology to keep track of our users and the services they have
  elected. We use both "session" and "persistent" cookies. Session cookies are deleted after
  you leave our website and when you close your browser. We use data collected with session
  cookies to enable certain features on our Site, to help us understand how users interact
  with our Site, and to monitor at an aggregate level Site usage and web traffic routing. We
  may allow business partners who provide services to our Site to place cookies on your
  computer that assist us in analyzing usage data. We do not allow these business partners to
  collect your personal information from our website except as may be necessary for the
  services that they provide.',
  'privacy_policy_heading_sixth' => 'Web Beacons',
  'privacy_policy_para_sixth' => 'We may also use web beacons or similar technology to help us track the effectiveness of our
communications.',
  'privacy_policy_heading_eighth' => 'Advertising Cookies',
  'privacy_policy_para_seventh' => 'We may use third parties, such as Google, to serve ads about our website over the internet.
  These third parties may use cookies to identify ads that may be relevant to your interest
  (for example, based on your recent visit to our website), to limit the number of times that
  you see an ad, and to measure the effectiveness of the ads.',
  'privacy_policy_heading_ninth' => 'Google Analytics',
  'privacy_policy_para_eighth' => 'We may also use Google Analytics or a similar service to gather statistical information
  about the visitors to this Site and how they use the Site. This, also, is done on an
  anonymous basis. We will not try to associate anonymous data with your personally
  identifiable data. If you would like to learn more about Google Analytics, please click
  here.',
  '6cash is the best digital wallet' => '6cash is the best digital wallet',
  'about_us_page' => '6cash is a digital wallet-supported system that offers secure and efficient transactions
  through a
  mobile application. It was created with the aim of providing a convenient and hassle-free
  way for
  people to manage their finances, whether it be sending or receiving money, making online
  purchases,
  or paying bills. As a digital wallet system, 6cash operates entirely online, allowing users
  to
  access their funds from anywhere with an internet connection. This means that users no
  longer need
  to carry cash or cards with them, reducing the risk of theft or loss. Moreover, it offers a
  fast and
  easy way to manage transactions without the need to go to a physical bank or financial
  institution.
  The 6cash platform is user-friendly and intuitive, making it accessible to people of all
  ages and
  backgrounds. It offers a range of features such as Add Money, Send Money, Cash Out., and
  Request
  Money, which can be accessed via the customer app and agent app. One of the key features of
  6cash is
  its QR code scanner, which allows for quick and safe transactions. Overall, 6cash is a
  digital
  wallet-supported system that offers a range of features to make financial management more
  accessible, secure, and efficient. With its user- friendly platform, advanced security
  features, and
  comprehensive transaction reports, 6cash is a reliable and convenient tool for managing your
  finances.',
  'Need Any Help' => 'Need Any Help',
  'Feel free to contact us any time.' => 'Feel free to contact us any time.',
  'We Support 24/7 Hour' => 'We Support 24/7 Hour',
  'Make Call' => 'Make Call',
  'Send Email' => 'Send Email',
  'Terms of Use' => 'Terms of Use',
  'This is A test terms & conditions' => 'This is A test terms & conditions',
  'term_para' => 'These terms of use (the "Terms of Use") govern your use of our website www.evaly.com.bd (the
  "Website") and our "StackFood" application for mobile and handheld devices (the "App"). The
  Website and the App are jointly referred to as the "Platform". Please read these Terms of
  Use carefully before you use the services. If you do not agree to these Terms of Use, you
  may not use the services on the Platform, and we request you to uninstall the App. By
  installing. downloading and/or even nmerely using the Platform, you shall be contracting
  with StackFood and you provide your acceptance to the Terms of Use and other StackFood
  policies (including but not limited to the Cancellation & Refund Policy. Privacy Policy
  etc.) as posted on the Platform from time to time, which takes effect on the date on which
  you download, install or use the Services, and create a legally binding arrangement to abide
  by the same. The Platforms will be used by () natural persons who have reached 18 years of
  age and (ii) corporate legal entities, e.g companies. Where applicable, these Terms shall be
  subject to country-specific provisions as set out herein.',
  'USE OF PLATFORM AND SERVICES' => 'USE OF PLATFORM AND SERVICES',
  'term_para_two' => 'All commercial/contractual terms are offered by and agreed to between Buyers and Merchants
  alone. The commercial/contractual terms include without limitation to price, taxes, shipping
  ...
  StackFood does not have any kind of control or does not determine or advise or in any way
  involve itself in the offering or acceptance of such commercial/contractual terms between
  the Buyers and Merchants. StackFood
  may, however, offer support services to Merchants in respect to order fulfilment, payment
  collection, call centre, and other services, pursuant to independent contracts executed by
  it with the Merchants. eFood is not responsible for any non-performance or breach of any
  contract entered into between Buyers and Merchants on the Platform. eFood cannot and does
  not guarantee that the concerned Buyers and/or Merchants shall perform any transaction
  concluded on the Platform. eFood is not responsible for unsatisfactory services or non-
  performance of services or damages or delays as a result of products which are out of stock,
  unavailable or back ordered.
  StackFood is operating an e-commerce platform and assumes and operates the role of
  facilitator, and does not at any point of time during any transaction between Buyer and
  Merchant on the Platform come into or take possession of any of the products or services
  offered by Merchant. At no time shall StackFood hold any right, title or interest over the
  products nor shall StackFood have any obligations or liabilities in respect of such contract
  entered into between Buyer and Merchant. You agree and acknowledge that we shall not be
  responsible for: The goods provided by the shops or restaurants including, but not limited,
  serving of food orders suiting your requirements and needs;
  The Merchant"s goods not being up to your expectations or leading to any loss, harm or
  damage to you;
  The availability or unavailability of certain items on the menu:
  The Merchant serving the incorrect orders. The details of the menu and price list available
  on the Platform are based on the information provided by the Merchants and we shall not be
  responsible for any change or cancelation or unavailability. All Menu & Food Images used on
  our platforms are only representative and shall/might not match with the actual Menu/Food
  Ordered, StackFood shall not be responsible or Liable for any discrepancies or variations on
  this aspect.',
  'Personal Information that you provide' => 'Personal Information that you provide',
  'term_para_three' => 'If you want to use our service, you must create an account on our Site. To establish your
  account, we will ask for personally identifiable information that can be used to contact or
  identify you, which may include your name, phone number, and e-mail address. We may also
  collect demographic information about you, such as your zip code, and allow you to submit
  additional information that will be part of your profile. Other than basic information that
  we need to establish your account, it will be up to you to decide howW much information to
  share as part of your profile. We encourage you to think carefuly about the information that
  you share and we recommend that you guard your identity and your sensitive information. Of
  course, you can review and revise your profile at any time. You understand that delivery
  periods quoted to you at the time of confirming the order is an approximate estimate and may
  vary. We shall not be responsible for any delay in the delivery of your order due to the
  delay at seller/ merchant end for order processing or any other unavoidable circumstances.',
  'Trasaction Limit' => 'Trasaction Limit',
  'Monthly Limit' => 'Monthly Limit',
  'Search Menu...' => 'Search Menu...',
  'Payment Method' => 'Payment Method',
  'Transaction should not with own number' => 'Transaction should not with own number',
  'Forgot PIN?' => 'Forgot PIN ',
  'Create 6Cash Agent account with your mobile number' => 'Create 6Cash Agent account with your mobile number',
  'Country' => 'Country',
  'City' => 'City',
  'Add Money requested to Admin!' => 'Add Money requested to Admin!',
  'Request money to Admin!' => 'Request money to Admin!',
  'Add Money Requests' => 'Add Money Requests',
  '_token' => ' token',
  'method_id' => 'Method id',
  'phone_number' => 'Phone number',
  'Add Money approved!' => 'Add Money approved!',
  'Add Money rejected !' => 'Add Money rejected !',
  'Secret PIN' => 'Secret PIN',
  'Generate Secret PIN Number' => 'Generate Secret PIN Number',
  'Search Agent Number' => 'Search Agent Number',
  'Countries' => 'Countries',
  'Country status updated successfully!' => 'Country status updated successfully!',
  'Add City' => 'Add City',
  'Name is required' => 'Name is required',
  'Status is required' => 'Status is required',
  'City is created' => 'City is created',
  'City status updated successfully!' => 'City status updated successfully!',
  'Location' => 'Location',
  'commission' => 'Commission',
  'fee' => 'Fee',
  'commission verify' => 'Commission verify',
  'fee verify' => 'Fee verify',
  'Add Agent Fee' => 'Add Agent Fee',
  'Fee is required' => 'Fee is required',
  'Fee updated successfully!' => 'Fee updated successfully!',
  'Please Commission Activate first.' => 'Please Commission Activate first.',
  'Add Commission' => 'Add Commission',
  'Agent Commission status updated!' => 'Agent Commission status updated!',
  'Commission updated successfully!' => 'Commission updated successfully!',
  'Fee' => 'Fee',
  'Agent Fee status updated!' => 'Agent Fee status updated!',
  ...
  'Currency Exchange Rate updated successfully!' => 'Currency Exchange Rate updated successfully!',
  'Add money requests' => 'Add money requests',
  'First Name is required' => 'First Name is required',
  'Last Name is required' => 'Last Name is required',
  'Gender is required' => 'Gender is required',
  'Occupation is required' => 'Occupation is required',
  'Dial Country code is required' => 'Dial Country code is required',
  'Phone must have at least 5 characters' => 'Phone must have at least 5 characters',
  'Phone must be less than 20 characters' => 'Phone must be less than 20 characters',
  'Country is required' => 'Country is required',
  'City is required' => 'City is required',
  'Password is required' => 'Password is required',
  'Password must have 4 characters' => 'Password must have 4 characters',
  'Profile updated successfully!' => 'Profile updated successfully!',
  'No agent selected!' => 'No agent selected!',
  'Plateform fee is not set yet!' => 'Plateform fee is not set yet!',
  'Money has been sent successfully!' => 'Money has been sent successfully!',
  'Payable' => 'Payable',
  'Cancel Transaction Successfully!' => 'Cancel Transaction Successfully!',
  'No Transaction found!' => 'No Transaction found!',
  'Secret Pin is required!' => 'Secret Pin is required!',
  'Sorry, Invalid PIN or No transaction found!' => 'Sorry  Invalid PIN or No transaction found!',
  'Insufficient balance!' => 'Insufficient balance!',
  'Transaction Detail' => 'Transaction Detail',
  'Money has been received!' => 'Money has been received!',
  'Transaction Details' => 'Transaction Details',
  'Number is ready to register' => 'Number is ready to register',
  'Sorry, You cannot revert this transaction!' => 'Sorry  You cannot revert this transaction!',
  'Canceled' => 'Canceled',
  'cancel' => 'Cancel',
  'Requested successfully!' => 'Requested successfully!',
  'Money Transfer' => 'Money Transfer',
  'Customer Phone' => 'Customer Phone',
  'Identication number is required' => 'Identication number is required',
  'Sorry, your account is already active!' => 'Sorry  your account is already active!',
  'Identification image is required' => 'Identification image is required',
  'Identification image is not valid' => 'Identification image is not valid',
  'Identication image must be PNG' => 'Identication image must be PNG',
  'Request has been sent!' => 'Request has been sent!',
  'Cash In' => 'Cash In',
  'Customer No.' => 'Customer No.',
  'Created At' => 'Created At',
  'Rejected Transaction Successfully!' => 'Rejected Transaction Successfully!',
  'Rejected' => 'Rejected',
  'Payable Exchange' => 'Payable Exchange',
  'Sender Customer' => 'Sender Customer',
  'Receiver Customer' => 'Receiver Customer',
  'Receiver Agent' => 'Receiver Agent',
