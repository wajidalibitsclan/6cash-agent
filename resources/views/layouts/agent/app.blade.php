...
<body class="footer-offset">
    ...
    <!-- Builder -->
    @include('layouts.agent.partials._front-settings')
    <!-- End Builder -->
    ...
    <script>
        function deleteAccount(id) {
            const removeAccountURL = `{{ route('agent.remove.account', ['id' => 'REPLACE_WITH_DYNAMIC_ID']) }}`.replace(
                'REPLACE_WITH_DYNAMIC_ID', id);
            Swal.fire({
                title: 'Are you sure?',
