        ...
        <div class="card">
            <div class="card-header __wrap-gap-10 flex-between">
                ...
                <div class="flex-between __wrap-gap-10 align-items-center">
                    {{-- <a class="btn-sm btn-secondary form-control" href="{{route('merchant.withdraw.download', ['withdrawal_method'=>$method,'search'=>$search, 'request_status'=>$request_status])}}">{{translate('Export')}}</a> --}}
                    <div class="">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-2" href="{{route('merchant.withdraw.download', ['withdrawal_method'=>$method,'search'=>$search, 'request_status'=>$request_status])}}">
                ...
                <table
                    ...
                    @forelse($withdraw_requests as $key=>$withdraw_request)
                        <tr>
                            ...
                            <td><span class="badge badge-pill">{{ translate($withdraw_request->withdrawal_method ? $withdraw_request->withdrawal_method->method_name : '') }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="mx-w300 mn-w160 text-wrap">{{ $withdraw_request->admin_note }}</div>
                            </td>
                            <td>
