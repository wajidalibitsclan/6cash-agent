...
<head>
    ...
    <!-- Title -->
    <title>{{ translate('Agent') }} | {{ translate('Reset PIN') }}</title>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6">
                        <div class="bg-white h-100 d-flex align-items-center justify-content-center py-5 px-4">
                            <!-- Form -->
                            <form class="" action="{{ route('agent.auth.reset.pin') }}" method="post"
                                id="form-id">
                                @csrf
                                <div class="text-center">
                                    <div class="mb-5">
                                ...
                                <div class="js-form-message form-group">
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="js-toggle-password form-control __form-control"
                                            ...
                                            oninput="validateInput(event)" aria-label="4 characters required"
                                            aria-label="4 characters required" required
                                ...
                                <div class="js-form-message form-group">
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="js-toggle-password form-control __form-control"
                                            ...
                                            placeholder="{{ translate('confirm PIN') }}" oninput="validateInput(event)"
                                            aria-label="4 characters required" aria-label="4 characters required"
                                            required
