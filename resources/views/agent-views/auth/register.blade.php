...
<head>
    ...
    <!-- Title -->
    <title>{{ translate('Agent') }} | {{ translate('Register Page') }}</title>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6">
                        <div class="bg-white h-100 d-flex align-items-center justify-content-center py-5 px-4">
                            <!-- Form -->
                            <form class="" action="{{ route('agent.auth.checkphone') }}" method="post"
                                id="form-id">
                                @csrf
                                <div class="text-center">
                                    <div class="mb-5">
                                        <h2 class="text-capitalize">{{ translate('registeration') }}</h2>
                                    </div>
                                </div>

                                <!--Upper Text-->
                                <div class="text-center">
                                    <p>{{ translate('Create 6Cash Agent account with your mobile number') }}</p>
                                </div>
                                ...
                                @else
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6 input-icons bg-white rounded" style="cursor: pointer"
                                            data-toggle="tooltip" data-placement="right"
                                            title="{{ translate('Click to refresh') }}">
                                            <a onclick="javascript:re_captcha();">
                                                <img src="{{ URL('/admin/auth/code/captcha/1') }}"
                                                    class="input-field h-75 rounded-10 border-bottom-0"
                                                    id="default_recaptcha_id" style="width: 90%;">
                                ...
                                <div class="d-flex justify-content-center mt-5">
                                    <button type="submit"
                                        class="btn btn-primary sign-in-button">{{ translate('verify Number') }}</button>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
