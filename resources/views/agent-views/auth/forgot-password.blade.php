...
<head>
    ...
    <!-- Title -->
    <title>{{ translate('Agent') }} | {{ translate('forgot password') }}</title>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6">
                        <div class="bg-white h-100 d-flex align-items-center justify-content-center py-5 px-4">
                            <!-- Form -->
                            <form class="" action="{{ route('agent.auth.forgot.password.otp') }}" method="post"
                                id="form-id">
                                @csrf
                                <div class="text-center">
                                    <div class="mb-5">
                                        <h2 class="text-capitalize">{{ translate('forgot password') }}</h2>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-center mt-5">
                                    <button type="submit"
                                        class="btn btn-primary sign-in-button">{{ translate('send OTP') }}</button>
                                    <a href="{{ route('agent.auth.login') }}"
                                        class="btn btn-link">{{ translate('I remember?') }}</a>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
