                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6">
                        <div class="bg-white h-100 d-flex align-items-center justify-content-center py-5 px-4">
                            <!-- Form -->
                            <form class="" action="{{ route('agent.auth.login') }}" method="post"
                                id="form-id">
                                @csrf
                                <div class="text-center">
                                    <div class="mb-5">
                                ...
                                <div class="d-flex justify-content-center mt-5">
                                    ...
                                    <a href="{{ route('agent.auth.register') }}"
                                        class="btn btn-link">{{ translate('join us') }}</a>
                                </div>
                                <div class="text-center mt-3">
                                    <a href="{{ route('agent.forgot.password') }}">{{ translate('Forgot PIN?') }}</a>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
