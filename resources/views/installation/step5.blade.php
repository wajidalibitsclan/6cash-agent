...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>6Cash Software Installation</h2>
                        ...
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="from-group">
                                    <label for="business_name" class="d-flex align-items-center gap-2 mb-2">
                                        First Name</label>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="confirm_password" class="d-flex align-items-center gap-2 mb-2">Confirm Password</label>
                                    <div class="input-inner-end-ele position-relative">
